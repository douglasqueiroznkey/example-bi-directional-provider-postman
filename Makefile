...
PACT_CLI_DOCKER_RUN_COMMAND?=docker run --rm -v /${PWD}:/${PWD} -w ${PWD} -e PACT_BROKER_BASE_URL=https://nkey.pactflow.io -e PACT_BROKER_TOKEN=XP6ltR3bMFs3vX082cXJ0A pactfoundation/pact-cli:${PACT_CLI_DOCKER_VERSION}
